...
../comptes-rendus/cr_sigma.md : comment je convertis une règle Wazuh en Sigma
(repérer la source du log, choisir le bon logsource, traduire la syntaxe de
match), la table de correspondance des champs, et le détail des bugs/pièges
